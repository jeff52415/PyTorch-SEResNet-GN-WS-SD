...
class SEBottleneck(Bottleneck):
    ...
    def __init__(self, inplanes, planes, groups, reduction, stride=1,
        ...
        if group_normalization:
            ...
            self.bn1 = nn.GroupNorm(32, planes_input_shallow)

            planes_input = planes * 4
            self.bn2 = nn.GroupNorm(32, planes_input)
            self.bn3 = nn.GroupNorm(32, planes_input)
        else:
...
class SENet(nn.Module):
    ...
    def __init__(self, block, layers, groups, reduction, dropout_p=0.2,
        ...
        get_probability = torch.linspace(start=1, end=0.5, steps=layer_count)
        self.probabilities = []
        n = 0
        for layer in layers:
        ...
        self.layer1 = self._make_layer(
            ...
            probability_list=self.probabilities[0],
        )
        ...
        self.layer3 = self._make_layer(
            ...
            weight_standardization=weight_standardization,
            stochastic_depth=stochastic_depth,
            probability_list=self.probabilities[2],
        )
        self.layer4 = self._make_layer(
            ...
            weight_standardization=weight_standardization,
            stochastic_depth=stochastic_depth,
            probability_list=self.probabilities[3],
        )
        self.avg_pool = nn.AdaptiveAvgPool2d(1)
